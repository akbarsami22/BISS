            ...
            <div class="col-md-11 col-lg-9">
                <div class="card shadow-sm">
                    <div class="card-body p-5">
                        <h3 class="card-title text-center mb-5">Edit Book</h3>
                        <form id="bookEditForm" method="put">
                            <div class="mb-4">
                                <label for="title" class="form-label fw-bold">Title</label>
                                <input type="text" class="form-control form-control-lg" id="title" name="title" value="{{$book->title}}" placeholder="Book Title">
                                <p></p>
                            </div>
                            <div class="mb-4">
                                <label for="author" class="form-label fw-bold">Author</label>
                                <input type="text" class="form-control form-control-lg" id="author" name="author" value="{{$book->author}}" placeholder="Author's Name">
                                <p></p>
                            </div>
                            <div class="mb-4">
                                <label for="publisher" class="form-label fw-bold">Publisher</label>
                                <input type="text" class="form-control form-control-lg" id="publisher" name="publisher" value="{{$book->publisher}}" placeholder="Publisher's Name">
                                <p></p>
                            </div>
                            <div class="mb-4">
                                <label for="year" class="form-label fw-bold">Year Published</label>
                                <input type="number" class="form-control form-control-lg" id="year" name="year" value="{{$book->Year_published}}" placeholder="Year of Publication">
                                <p></p>
                            </div>
                            <div class="d-grid">
